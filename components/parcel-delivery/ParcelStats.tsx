...
const STATS = [
  { value: '30 km', label: 'Service radius per city' },
  { value: '~30 min', label: 'Average delivery time' },
  { value: '4.8★', label: 'Average captain rating' },
];

export default function ParcelStats({ isDesktop }: { isDesktop: boolean }) {
  return (
...
const styles = StyleSheet.create({
  ...
  statLabel: { fontFamily: fonts.body, fontSize: 12, color: colors.bodyMutedOnLight, marginTop: 4 },
});
